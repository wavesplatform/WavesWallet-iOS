...
/// Usage: instantiate Acash_ACashExchangeClient, then call methods of this protocol to make API calls.
public protocol Acash_ACashExchangeClientProtocol {
...
public final class Acash_ACashExchangeClient: GRPCClient, Acash_ACashExchangeClientProtocol {
  public let channel: GRPCChannel
  public var defaultCallOptions: CallOptions

  /// Creates a client for the acash.ACashExchange service.
  ///
  /// - Parameters:
  ...
  public func getACashAssets(_ request: Acash_GetACashAssetsRequest, callOptions: CallOptions? = nil) -> UnaryCall<Acash_GetACashAssetsRequest, Acash_GetACashAssetsResponse> {
    return self.makeUnaryCall(path: "/acash.ACashExchange/GetACashAssets",
                              request: request,
  ...
  public func getACashAssetsExchangeRate(_ request: Acash_GetACashAssetsExchangeRateRequest, callOptions: CallOptions? = nil) -> UnaryCall<Acash_GetACashAssetsExchangeRateRequest, Acash_GetACashAssetsExchangeRateResponse> {
    return self.makeUnaryCall(path: "/acash.ACashExchange/GetACashAssetsExchangeRate",
                              request: request,
                              callOptions: callOptions ?? self.defaultCallOptions)
  }
