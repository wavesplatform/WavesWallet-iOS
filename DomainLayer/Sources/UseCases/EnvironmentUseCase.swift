...
//final class EnvironmentUseCase: EnvironmentUseCaseProtocol {
//
//}
...
//    }()
//    
//    private lazy var setupServicesEnviromentShare: Observable<ApplicationEnviroment> =
...
//        setupServicesEnviromentShare.map { $0.walletEnvironment }
//    }
//    
//    func applicationEnvironment() -> Observable<ApplicationEnvironmentProtocol> {
//        setupServicesEnviromentShare.map { $0 as ApplicationEnvironmentProtocol }
//    }
//    
//    func servicesEnvironment() -> Observable<ApplicationEnviroment> {
//        setupServicesEnviromentShare
//    }
//    
...
//                }
//                
//                return self.initializationService(environment: enviroment).map { services in
//                    ApplicationEnviroment(wavesServices: services, walletEnvironment: enviroment, timestampServerDiff: 0)
//                }
//            }
...
//                        })
//                        .map { time in
//                            ApplicationEnviroment(wavesServices: servicesEnviroment.wavesServices,
//                                                  walletEnvironment: servicesEnviroment.walletEnvironment,
...
//        Observable<WalletEnvironment>.create { [weak self] observer -> Disposable in
//            guard let self = self else {
//                return Disposables.create()
//            }
//            
