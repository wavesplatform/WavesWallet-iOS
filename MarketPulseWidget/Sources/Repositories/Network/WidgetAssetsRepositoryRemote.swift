...
final class WidgetAssetsRepositoryRemote: WidgetAssetsRepositoryProtocol {
    private lazy var assetsDataService: WidgetAssetsDataServiceProtocol = WidgetAssetsDataService(environmentRepository: environmentRepository)
