...
final class MarketPulseWidgetSettingsRepositoryMock: MarketPulseWidgetSettingsRepositoryProtocol {
    func settings() -> Observable<DomainLayer.DTO.MarketPulseSettings> {
        ...
        let btcIcon = DomainLayer.DTO.MarketPulseSettings.Asset
            .IconStyle(icon: .init(assetId: "8LQW8f7P5d5PZM7GtZEBgaqRPGSzS3DfPuiXrURJ4AJS",
                                   name: "Bitcoin",
                                   url: "https://d1jh0rcszsaxik.cloudfront.net/assset_icons/logo_bitcoin_48.png"),
                       isSponsored: false,
                       hasScript: false)
        
        let ethIcon = DomainLayer.DTO.MarketPulseSettings.Asset
            .IconStyle(icon: .init(assetId: "474jTeYx2r2Va35794tCScAXWJG9hU2HcgxzMowaZUnu",
                                   name: "Ethereum",
                                   url: "https://d1jh0rcszsaxik.cloudfront.net/assset_icons/logo_ethereum_48.png"),
                       isSponsored: false,
                       hasScript: false)
        
        let zecIcon = DomainLayer.DTO.MarketPulseSettings.Asset
            .IconStyle(icon: .init(assetId: "BrjUWjndUanm5VsJkbUip8VRYy6LWJePtxya3FNv4TQa",
                                   name: "zCash",
                                   url: "https://d1jh0rcszsaxik.cloudfront.net/assset_icons/logo_zec_48.png"),
                       isSponsored: false,
                       hasScript: false)
        
        let btcCashIcon = DomainLayer.DTO.MarketPulseSettings.Asset
            .IconStyle(icon: .init(assetId: "zMFqXuoyrn5w17PFurTqxB7GsS71fp9dfk6XFwxbPCy",
                                   name: "Bitcoin Cash",
                                   url: "https://d1jh0rcszsaxik.cloudfront.net/assset_icons/logo_bitcoincash_48.png"),
                       isSponsored: false,
                       hasScript: false)
        
        let moneroIcon = DomainLayer.DTO.MarketPulseSettings.Asset
            .IconStyle(icon: .init(assetId: "5WvPKSJXzVE2orvbkJ8wsQmmQKqTv9sGBPksV4adViw3",
                                   name: "Monero",
                                   url: "https://d1jh0rcszsaxik.cloudfront.net/assset_icons/logo_monero_48.png"),
                       isSponsored: false,
                       hasScript: false)
        
        let ltcIcon = DomainLayer.DTO.MarketPulseSettings.Asset
            .IconStyle(icon: .init(assetId: "HZk1mbfuJpmxU1Fs4AX5MWLVYtctsNcg6e2C6VKqK8zk",
                                   name: "Litecoin",
                                   url: "https://d1jh0rcszsaxik.cloudfront.net/assset_icons/logo_ltc_48.png"),
                       isSponsored: false,
                       hasScript: false)
        
        let wavesIcon = DomainLayer.DTO.MarketPulseSettings.Asset
            .IconStyle(icon: .init(assetId: "WAVES",
                                   name: "WAVES",
        ...
        return Observable.just(.init(isDarkStyle: false, interval: .m1, assets: initAssets))
    }
}
