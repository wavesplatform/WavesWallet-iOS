...
struct Acash_StorePayerDetailsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var payerDetails: Acash_PayerDetails {
  ...
  var hasPayerDetails: Bool {return self._payerDetails != nil}
  /// Clears the value of `payerDetails`. Subsequent reads from it will return its default value.
  mutating func clearPayerDetails() {self._payerDetails = nil}
...
struct Acash_StorePayerDetailsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Acash_PayerDetails {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var expiryMonth: UInt32 = 0

  var expiryYear: UInt32 = 0

  var cardNumber: String = String()

  var cardHolder: String = String()

  var cardHolderCountry: String = String()

  var cardHolderCity: String = String()

  var cardHolderDob: String = String()

  var cardHolderMobilePhoneNumber: String = String()
...
extension Acash_StorePayerDetailsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".StorePayerDetailsRequest"
  ...
  static func ==(lhs: Acash_StorePayerDetailsRequest, rhs: Acash_StorePayerDetailsRequest) -> Bool {
...
extension Acash_StorePayerDetailsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".StorePayerDetailsResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Acash_StorePayerDetailsResponse, rhs: Acash_StorePayerDetailsResponse) -> Bool {
...
extension Acash_PayerDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PayerDetails"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Acash_PayerDetails, rhs: Acash_PayerDetails) -> Bool {
