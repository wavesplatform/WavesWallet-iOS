...
protocol MyAddressesKeysModuleOutput: AnyObject {
...
protocol MyAddressesKeysModuleInput {
    var wallet: DomainLayer.DTO.Wallet { get }
}

protocol MyAddressesKeysPresenterProtocol {

    typealias Feedback = (Driver<MyAddressesKeysTypes.State>) -> Signal<MyAddressesKeysTypes.Event>

    var moduleOutput: MyAddressesKeysModuleOutput? { get set }
    var moduleInput: MyAddressesKeysModuleInput! { get set }
    func system(feedbacks: [Feedback])
}

final class MyAddressesKeysPresenter: MyAddressesKeysPresenterProtocol {

    fileprivate typealias Types = MyAddressesKeysTypes
    ...
    var moduleInput: MyAddressesKeysModuleInput!
    weak var moduleOutput: MyAddressesKeysModuleOutput?
...
//        newFeedbacks.append(externalQuery())
        ...
        let system = Driver.system(initialState: initialState,
                                   reduce: MyAddressesKeysPresenter.reduce,
...
fileprivate extension MyAddressesKeysPresenter {
...
private extension MyAddressesKeysPresenter {
