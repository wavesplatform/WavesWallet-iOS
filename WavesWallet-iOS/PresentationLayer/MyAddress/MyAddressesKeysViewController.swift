...
final class MyAddressesKeysViewController: UIViewController {

    typealias Types = MyAddressesKeysTypes
    ...
    var presenter: MyAddressesKeysPresenterProtocol!
...
private extension MyAddressesKeysViewController {

    func setupSystem() {

        let uiFeedback: MyAddressesKeysPresenterProtocol.Feedback = bind(self) { (owner, state) -> (Bindings<Types.Event>) in
            return Bindings(subscriptions: owner.subscriptions(state: state), events: owner.events())
        }

        let readyViewFeedback: MyAddressesKeysPresenterProtocol.Feedback = { [weak self] _ in
        ...
        let viewDidDisappearFeedback: MyAddressesKeysPresenterProtocol.Feedback = { [weak self] _ in
            guard let strongSelf = self else { return Signal.empty() }
...
extension MyAddressesKeysViewController: UITableViewDataSource {
...
extension MyAddressesKeysViewController: UITableViewDelegate {
...
extension MyAddressesKeysViewController: UIScrollViewDelegate {
