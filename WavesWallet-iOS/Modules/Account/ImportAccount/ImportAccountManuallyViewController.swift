...
final class ImportAccountManuallyViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBAction func continueTapped(_: Any) {
        UseCasesFactory
            .instance
            .analyticManager
            .trackEvent(.importAccount(.startImportManually))
        completedInput()
    }
...
extension ImportAccountManuallyViewController: MultilineTextFieldDelegate {
    func multilineTextFieldShouldReturn(textField _: MultilineTextField) {
        completedInput()
    }
    ...
    func multilineTextFieldDidChange(textField: MultilineTextField) {
        ...
        let isActiveSeed = textField.isValidValue && !seed.isEmpty
    ...
    func multilineTextField(textField _: MultilineTextField, errorTextForValue value: String) -> String? {
