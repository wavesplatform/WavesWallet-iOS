...
final class DexCreateOrderInputView: UIView, NibOwnerLoadable {
    ...
    var inputType: InputType = .default {
        didSet {
            ...
            textFieldLeftOffset.constant = inputType == .default ? Constants.textFieldDefaultOffset : Constants
                .textFieldMarketOffset
...
extension DexCreateOrderInputView: MoneyTextFieldDelegate {
    func moneyTextField(_: MoneyTextField, didChangeValue _: Money) {
...
private extension DexCreateOrderInputView {
    @IBAction func plusTapped(_: Any) {
        textField.addPlusValue()

        textFieldDidChangeNewValue()
    }

    @IBAction func minusTapped(_: Any) {
