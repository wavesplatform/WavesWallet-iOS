...
final class ReceiveAddressViewController: UIViewController {
    ...
    private func createCancelButton() {
        navigationItem
            .leftBarButtonItem = UIBarButtonItem(image: Images.topbarClosewhite.image, style: .plain, target: self,
    ...
    private func createInfoButton() {
        navigationItem
            .rightBarButtonItem = UIBarButtonItem(image: Images.topbarInfowhite.image, style: .plain, target: self,
