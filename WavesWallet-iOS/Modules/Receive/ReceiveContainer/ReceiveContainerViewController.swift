...
final class ReceiveContainerViewController: UIViewController {
    ...
    private func createInfoButton() {
        navigationItem
            .rightBarButtonItem = UIBarButtonItem(image: Images.topbarInfowhite.image.withRenderingMode(.alwaysTemplate),
                                                  style: .plain, target: self, action: #selector(receiveAddressDidShowInfo))
    ...
    @objc func receiveAddressDidShowInfo() {
        ...
        let data = TooltipTypes.DTO.Data(title: title,
                                         elements: elements)
...
private extension ReceiveContainerViewController {
    ...
    @IBAction func segmentedDidChange(_: Any) {
