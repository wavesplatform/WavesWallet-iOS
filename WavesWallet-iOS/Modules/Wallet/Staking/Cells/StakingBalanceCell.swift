...
final class StakingBalanceCell: UITableViewCell, NibReusable {
    ...
    @IBAction private func depositTapped(_: Any) {
        depositAction?()
    }

    @IBAction private func withdrawTapped(_: Any) {
        withdrawAction?()
    }

    @IBAction private func tradeTapped(_: Any) {
        tradeAction?()
    }

    @IBAction private func buyTapped(_: Any) {
        buyAction?()
    }
}
