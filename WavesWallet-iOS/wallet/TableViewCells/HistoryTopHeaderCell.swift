...
class HistoryTopHeaderCell: UITableViewCell {
    ...
    @IBOutlet var buttonSent: UIButton!
    @IBOutlet var buttonReceived: UIButton!
    @IBOutlet var buttonExchanged: UIButton!
    @IBOutlet var buttonLeased: UIButton!
    @IBOutlet var buttonIssued: UIButton!
    @IBOutlet var leftViewOffset: NSLayoutConstraint!
