...
final class ScannerCustomView: UIView, QRCodeReaderDisplayable {
    ...
    func setupComponents(showCancelButton: Bool,
        ...
        if showOverlayView {
            ...
            let frame = CGRect(x: (Platform.ScreenWidth - width) / 2,
        ...
        if showCancelButton {
            ...
            cancelButton?.frame = CGRect(x: (Platform.ScreenWidth - buttonWidth) / 2,
                                         y: UIScreen.main.bounds.size.height - buttonHeight - offset,
                                         width: buttonWidth,
                                         height: buttonHeight)
        ...
        let titleLabelRect = CGRect(x: 0, y: Platform.isIphoneXSeries ? 50 : 30, width: Platform.ScreenWidth, height: 20)
        let labelTitle = UILabel(frame: titleLabelRect)
