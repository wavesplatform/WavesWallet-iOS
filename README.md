...
This repository contains the source code for the Waves Wallet iOS app.

This is the same repository as the now-defunct [official Waves Wallet](https://itunes.apple.com/us/app/waves-wallet/id1233158971?mt=8) iOS app.
